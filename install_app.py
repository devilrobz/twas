...
print "Installing application ...file: app.ear"
print "to change app just edit this script same goes with desired name etc."
print "BR Was Wasson"

node = getName(getNodeId(""))
server = getName(getServerId(""))
parms = "-appname WAS_APP"
parms += " -node " + node + " -server " + server
parms += " -nouseMetaDataFromBinary"
parms += " -defaultbinding.virtual.host default_host"
